  ...
  return (
    <>
      ...
      <section
        ...
        className="fade-in-contact relative mx-8 lg:h-[calc(100vh-5rem)] xl:h-[calc(90vh-5rem)] 2xl:h-[calc(80vh-5rem)] mt-16 md:mt-0 flex flex-col lg:flex-row justify-between items-center bg-black text-lightBeige xl:gap-12 2xl:gap-16 xl:mx-32 2xl:mx-64"
      >
        ...
        {/* Social Links */}
        <div className="mt-16 md:mt-20 lg:mt-0 flex flex-col gap-4 lg:px-20 md:w-10/12 lg:w-1/2 xl:gap-6 2xl:gap-8">
