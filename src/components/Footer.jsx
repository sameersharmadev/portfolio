...
export default function Footer() {
    return(
    <div className="h-10 flex text-sm md:text-base flex-row-reverse justify-center items-center fade-in-hero text-secondaryBeige gap-4 mt-16 lg:my-0 2xl:text-3xl">
