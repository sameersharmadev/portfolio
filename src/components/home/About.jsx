...
export default function About(){
    return(
        <div className="relative md:h-[calc(100vh-2.5rem)] flex justify-between items-center fade-in-section bg-black text-lightBeige">
            <div className="w-full lg:w-1/2 ml-4 mr-4 md:ml-20 md:mr-20 lg:mr-4 2xl:mx-64 md:h-[66vh]">
                <h2 className="text-2xl mt-8 md:mt-0 md:text-4xl font-semibold md:-mt-8 mb-6 2xl:text-7xl 2xl:mb-12">About me</h2>
                    <ul className="flex flex-col mb-4 2xl:text-4xl 2xl:leading-loose">
                    <li className="relative pl-8 pb-4 2xl:pl-16 2xl:pb-8">
                        <span className="w-4 h-4 2xl:w-8 2xl:h-8 bg-lightBeige rounded-full absolute top-0 left-0"></span>
                        <span className="w-1  bg-lightBeige absolute top-0 left-1.5 2xl:left-3 2xl:w-2 bottom-0"></span>
                        <p className="2xl:-mt-4">
                ...
                <div className="flex gap-4 2xl:gap-8 items-center">
                    <div>
                        <FontAwesomeIcon icon={faGraduationCap} className="text-5xl 2xl:text-8xl"/>
                    </div>
                    <div className="flex flex-col mb-8 2xl:mb-24 justify-center items-center">
                        <p className="font-semibold 2xl:text-4xl 2xl:pt-24">Bachelor of Technology (Computer Science Engineering)</p>
                        <p className="2xl:text-4xl">Maharaja Agrasen Institute of Technology [2023-2027]</p>
                    </div>
                    
                </div>
                <Link to="/about" className="block w-full rounded text-center md:text-xl bg-lightBeige text-black p-1 2xl:p-4 2xl:text-4xl">
                    View more
                </Link>
