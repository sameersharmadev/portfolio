  ...
  return(
    <div className="relative h-[calc(100vh-2.5rem)] flex justify-center items-center bg-lightBeige fade-in-hero">
      <div className="flex flex-col lg:flex-row gap-8 xl:gap-16 2xl:gap-32 items-center">
        ...
        <div className="flex flex-col px-8 lg:px-0 xl:px-8 2xl:px-16">
          <p className="-mt-4 lg:text-2xl xl:text-5xl 2xl:text-7xl xl:mb-2 2xl:mb-2">Hello there! I am</p>
          <h1 className="text-4xl lg:text-7xl xl:text-9xl 2xl:text-[12rem] lg:mb-2 xl:mb-4 2xl:mb-4">Sameer Sharma</h1>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-4 xl:gap-6 2xl:gap-12 mb-4 lg:mb-8 xl:mb-10 2xl:mb-12 justify-between">
          ...
          <Link to="/projects" className="w-full text-center text-lg lg:text-xl xl:text-3xl 2xl:text-4xl bg-black text-lightBeige p-2 lg:p-3 xl:p-5 2xl:p-6 mb-2 lg:mb-4 xl:mb-6 2xl:mb-8 hover:bg-blackHover transition">
            View my work
          </Link>
          <Link to="/contact" className="text-lg lg:text-xl xl:text-3xl 2xl:text-4xl text-center transition">
            Contact me
          </Link>
        </div>
      </div>
