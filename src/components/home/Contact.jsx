...
export default function Contact() {
  ...
  function Socials({ link, icon, name }) {
    return (
      <div
        ...
        className="flex flex-col items-center gap-4 bg-blackCards p-6 rounded-lg shadow-md cursor-pointer hover:text-headerBeige transition w-32 md:w-32 xl:w-48 xl:h-48 justify-center 2xl:w-52 2xl:h-52"
      >
  ...
  return (
    <section className="relative my-16 md:my-24 flex flex-col lg:flex-row justify-center items-center fade-in-section bg-black text-lightBeige xl:gap-8 2xl:gap-12 xl:mx-20 2xl:mx-32 xl:h-[60vh] 2xl:h-[60vh]">
      <div className="mx-4 lg:ml-20 xl:mx-16 2xl:mx-32 flex md:w-1/2 flex-col justify-center items-center lg:items-start xl:gap-12 2xl:gap-16">
        {/* Heading */}
      ...
      <div className="w-1/2 hidden lg:flex justify-start items-start -mt-16 p-0 m-0">
        <ul className="space-y-4 text-gray-700 dark:text-gray-300 text-sm md:text-base xl:text-3xl xl:space-y-8 2xl:text-4xl 2xl:space-y-8">
          ...
          <li className="flex items-start gap-2 mt-16">
            ...
            <span>It is currently {time} in my location</span>
          </li>
          <li className="flex items-start gap-2">
